...
nohup python eval_sharpness.py --shots 8 --opt sam > logs/sam8-sharpness.log 2>&1 &
nohup python eval_sharpness.py --shots 8 --opt sgd > logs/sgd8-sharpness.log 2>&1 &
nohup python eval_sharpness.py --shots 8 --opt sgd_momentum > logs/sgd_momentum8-sharpness.log 2>&1 &

nohup python eval_sharpness.py --shots 4 --opt sam > logs/sam4-sharpness.log 2>&1 &
nohup python eval_sharpness.py --shots 4 --opt sgd > logs/sgd4-sharpness.log 2>&1 &
nohup python eval_sharpness.py --shots 4 --opt sgd_momentum > logs/sgd_momentum4-sharpness.log 2>&1 &

nohup python eval_sharpness.py --shots 1 --opt sam > logs/sam2-sharpness.log 2>&1 &
nohup python eval_sharpness.py --shots 1 --opt sgd > logs/sgd2-sharpness.log 2>&1 &
nohup python eval_sharpness.py --shots 1 --opt sgd_momentum > logs/sgd_momentum2-sharpness.log 2>&1 &
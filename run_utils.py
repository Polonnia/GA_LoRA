...
def get_arguments():
    ...
    parser.add_argument('--result_path', default=None, type=str, help='directory to save validation results (e.g., accuracies)')
    parser.add_argument('--eval_datasets', default=None, type=lambda x: x.split(','), help='comma-separated list of eval datasets, e.g. imagenet-v2,imagenet-a,imagenet-r')
